...
<div className={styles.xdaTq}>
  <a className={styles.navigationText} href="#">
    <p><span className={styles.nameSecondary}>xd</span><span>aTq</span></p>
  </a>
</div>
<div className={styles.github}>
  <a className={styles.navigationText} href="#github">
    <p>
